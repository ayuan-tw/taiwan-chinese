...
// Ver.6.8.0: 2026-09-06までの追加候補。既存項目は重複追加しない。
const v68Words = [
  {category:"会話",word:"說得通",zhuyin:"ㄕㄨㄛ ㄉㄜ˙ ㄊㄨㄥ",meaning:"筋が通る／つじつまが合う",note:"説明や理由が論理的に理解できる時に使う。否定形は『說不通』。",example:"這樣就說得通了。",exampleZhuyin:"ㄓㄜˋ ㄧㄤˋ ㄐㄧㄡˋ ㄕㄨㄛ ㄉㄜ˙ ㄊㄨㄥ ㄌㄜ˙",tags:["会話","理解・納得","台湾人よく使う"]},
  {category:"一致",word:"對得上",zhuyin:"ㄉㄨㄟˋ ㄉㄜ˙ ㄕㄤˋ",meaning:"一致する／照合が合う／つじつまが合う",note:"数字・時間・内容など、二つのものを照らし合わせて一致する時。否定形は『對不上』。",example:"這樣就對得上了。",exampleZhuyin:"ㄓㄜˋ ㄧㄤˋ ㄐㄧㄡˋ ㄉㄨㄟˋ ㄉㄜ˙ ㄕㄤˋ ㄌㄜ˙",tags:["会話","比較","結果補語"]},
  {category:"スマホ",word:"開靜音",zhuyin:"ㄎㄞ ㄐㄧㄥˋ ㄧㄣ",meaning:"消音・マナーモードにする",note:"スマホなどの音を出さない設定にする口語表現。『調成靜音』とも言える。",example:"我平常都會開靜音。",exampleZhuyin:"ㄨㄛˇ ㄆㄧㄥˊ ㄔㄤˊ ㄉㄡ ㄏㄨㄟˋ ㄎㄞ ㄐㄧㄥˋ ㄧㄣ",tags:["日常","スマホ","会話"]},
  {category:"数量",word:"一大堆",zhuyin:"ㄧˊ ㄉㄚˋ ㄉㄨㄟ",meaning:"山ほど／ものすごくたくさん",note:"数が多いことを、少し大げさ・うんざりした感じでも言える口語。",example:"我本來只想買飲料，結果買了一大堆東西。",exampleZhuyin:"ㄨㄛˇ ㄅㄣˇ ㄌㄞˊ ㄓˇ ㄒㄧㄤˇ ㄇㄞˇ ㄧㄣˇ ㄌㄧㄠˋ，ㄐㄧㄝˊ ㄍㄨㄛˇ ㄇㄞˇ ㄌㄜ˙ ㄧˊ ㄉㄚˋ ㄉㄨㄟ ㄉㄨㄥ ㄒㄧ",tags:["数量","会話","台湾人よく使う"]},
  {category:"会話",word:"吐槽",zhuyin:"ㄊㄨˇ ㄘㄠˊ",meaning:"ツッコむ／突っ込みを入れる",note:"おかしな点を面白く指摘すること。台湾の会話やネットでよく使う。",example:"你在等我吐槽嗎？",exampleZhuyin:"ㄋㄧˇ ㄗㄞˋ ㄉㄥˇ ㄨㄛˇ ㄊㄨˇ ㄘㄠˊ ㄇㄚ˙",tags:["会話","驚き・ツッコミ","台湾人よく使う"]}
];
for (const item of v68Words) { if (!words.some(w => w.word === item.word)) words.push(item); }
...
const habits = [
  ...
  {category:"話題転換",ja:"～といえば",primary:"說到～",zhuyin:"ㄕㄨㄛ ㄉㄠˋ～",note:"前に出た言葉から関連話題を広げる。",example:"說到台灣，我又想去玩了。",exampleZhuyin:"ㄕㄨㄛ ㄉㄠˋ ㄊㄞˊ ㄨㄢ，ㄨㄛˇ ㄧㄡˋ ㄒㄧㄤˇ ㄑㄩˋ ㄨㄢˊ ㄌㄜ˙"},
  {category:"話題転換",ja:"～については／～のほうは",primary:"至於～",zhuyin:"ㄓˋ ㄩˊ～",note:"話題を分け、別の対象を取り上げる。",example:"至於超市嘛，我覺得全家的店員比較親切。",exampleZhuyin:"ㄓˋ ㄩˊ ㄔㄠ ㄕˋ ㄇㄚ˙，ㄨㄛˇ ㄐㄩㄝˊ ㄉㄜ˙ ㄑㄩㄢˊ ㄐㄧㄚ ㄉㄜ˙ ㄉㄧㄢˋ ㄩㄢˊ ㄅㄧˇ ㄐㄧㄠˋ ㄑㄧㄣ ㄑㄧㄝˋ"},
  {category:"話題転換",ja:"ところで",primary:"話說",zhuyin:"ㄏㄨㄚˋ ㄕㄨㄛ",note:"雑談で自然に別の話へ移る。",variants:[{label:"思い出した時",text:"對了",zhuyin:"ㄉㄨㄟˋ ㄌㄜ˙"}]},
  {category:"話題転換",ja:"じゃあ／それなら",primary:"那就～",zhuyin:"ㄋㄚˋ ㄐㄧㄡˋ～",note:"前の話を受けて、次の行動や結論へ進む。",example:"那就明天再說吧。",exampleZhuyin:"ㄋㄚˋ ㄐㄧㄡˋ ㄇㄧㄥˊ ㄊㄧㄢ ㄗㄞˋ ㄕㄨㄛ ㄅㄚ˙"},
  {category:"話題転換",ja:"とりあえず",primary:"先～再說",zhuyin:"ㄒㄧㄢ～ㄗㄞˋ ㄕㄨㄛ",note:"細かいことは後にして、まず行動する。",example:"先吃飯再說。",exampleZhuyin:"ㄒㄧㄢ ㄔ ㄈㄢˋ ㄗㄞˋ ㄕㄨㄛ",variants:[{label:"まとめて切り出す",text:"總之先～",zhuyin:"ㄗㄨㄥˇ ㄓ ㄒㄧㄢ～",example:"總之先吃飯。",exampleZhuyin:"ㄗㄨㄥˇ ㄓ ㄒㄧㄢ ㄔ ㄈㄢˋ"}]},
  ...
  {category:"思い出す",ja:"○○ってなんだっけ？",primary:"○○是什麼來著？",zhuyin:"○○ ㄕˋ ㄕㄣˊ ㄇㄜ˙ ㄌㄞˊ ㄓㄜ˙",note:"知っていたはずの内容を思い出そうとする。",example:"那家店的名字是什麼來著？",exampleZhuyin:"ㄋㄚˋ ㄐㄧㄚ ㄉㄧㄢˋ ㄉㄜ˙ ㄇㄧㄥˊ ㄗˋ ㄕˋ ㄕㄣˊ ㄇㄜ˙ ㄌㄞˊ ㄓㄜ˙"},
  {category:"思い出す",ja:"なんて言うんだっけ？",primary:"怎麼說來著？",zhuyin:"ㄗㄣˇ ㄇㄜ˙ ㄕㄨㄛ ㄌㄞˊ ㄓㄜ˙",note:"言い方を思い出せない時。"},
  {category:"思い出す",ja:"あ、○○だったか",primary:"原來是○○啊。",zhuyin:"ㄩㄢˊ ㄌㄞˊ ㄕˋ○○ ㄚ",note:"答えを知って『それだったか』と納得する。",example:"原來是「收到」啊。",exampleZhuyin:"ㄩㄢˊ ㄌㄞˊ ㄕˋ ㄕㄡ ㄉㄠˋ ㄚ"},
  ...
  ,{category:"会話進行",ja:"よし、～しようっと",primary:"好，來～吧。",zhuyin:"ㄏㄠˇ，ㄌㄞˊ～ㄅㄚ˙",note:"気持ちを切り替えて、これから自分がすることを口に出す。",example:"好，來整理一下吧。",exampleZhuyin:"ㄏㄠˇ，ㄌㄞˊ ㄓㄥˇ ㄌㄧˇ ㄧˊ ㄒㄧㄚˋ ㄅㄚ˙"}
  ,{category:"会話進行",ja:"じゃ、～しよっと",primary:"那我來～好了。",zhuyin:"ㄋㄚˋ ㄨㄛˇ ㄌㄞˊ～ㄏㄠˇ ㄌㄜ˙",note:"状況を受けて、自分が何をするか軽く決める言い方。",example:"那我來洗澡好了。",exampleZhuyin:"ㄋㄚˋ ㄨㄛˇ ㄌㄞˊ ㄒㄧˇ ㄗㄠˇ ㄏㄠˇ ㄌㄜ˙"}
];
...
const v68Idioms = [
  {category:"気持ち",text:"好不甘心喔！",zhuyin:"ㄏㄠˇ ㄅㄨˋ ㄍㄢ ㄒㄧㄣ ㄛ˙",meaning:"めっちゃ悔しい！／すごく心残り！",note:"負けた時や、できそうだったのにできなかった時の悔しさ。台湾らしい口語。",tags:["感情","リアクション","台湾人よく使う","あゆあん語録"]}
];
for (const item of v68Idioms) { if (!idioms.some(i => i.text === item.text)) idioms.push(item); }
...
const v68Patterns = [
  {category:"後悔",pattern:"早知道 A，就 B 了",zhuyin:"ㄗㄠˇ ㄓ ㄉㄠˋ A，ㄐㄧㄡˋ B ㄌㄜ˙",meaning:"こうなると知っていたらBしたのに／Bすればよかった",note:"実際の結果を知った後で、過去の選択を後悔する型。Bには『不～』『先～』など、実際にはしなかった行動を置く。",example:"早知道會這麼累，我就不參加了。",exampleZhuyin:"ㄗㄠˇ ㄓ ㄉㄠˋ ㄏㄨㄟˋ ㄓㄜˋ ㄇㄜ˙ ㄌㄟˋ，ㄨㄛˇ ㄐㄧㄡˋ ㄅㄨˋ ㄘㄢ ㄐㄧㄚ ㄌㄜ˙",tags:["会話","後悔","就"],prompts:[{ja:"こんなに疲れると知っていたら、参加しなかったのに",answer:"早知道會這麼累，我就不參加了。",zhuyin:"ㄗㄠˇ ㄓ ㄉㄠˋ ㄏㄨㄟˋ ㄓㄜˋ ㄇㄜ˙ ㄌㄟˋ，ㄨㄛˇ ㄐㄧㄡˋ ㄅㄨˋ ㄘㄢ ㄐㄧㄚ ㄌㄜ˙"},{ja:"こんなに便利なら、もっと早く使えばよかった",answer:"早知道這麼好用，我就早一點用了。",zhuyin:"ㄗㄠˇ ㄓ ㄉㄠˋ ㄓㄜˋ ㄇㄜ˙ ㄏㄠˇ ㄩㄥˋ，ㄨㄛˇ ㄐㄧㄡˋ ㄗㄠˇ ㄧˋ ㄉㄧㄢˇ ㄩㄥˋ ㄌㄜ˙"}]},
  {category:"習慣",pattern:"平常都～",zhuyin:"ㄆㄧㄥˊ ㄔㄤˊ ㄉㄡ～",meaning:"普段はいつも～／普段は～している",note:"平常で普段の状況を示し、都で習慣的・一貫してそうすることを表す。既存の單字『平常』と一緒に覚える。",example:"我平常都會開靜音。",exampleZhuyin:"ㄨㄛˇ ㄆㄧㄥˊ ㄔㄤˊ ㄉㄡ ㄏㄨㄟˋ ㄎㄞ ㄐㄧㄥˋ ㄧㄣ",tags:["習慣","日常","会話"],prompts:[{ja:"私は普段いつも消音にしている",answer:"我平常都會開靜音。",zhuyin:"ㄨㄛˇ ㄆㄧㄥˊ ㄔㄤˊ ㄉㄡ ㄏㄨㄟˋ ㄎㄞ ㄐㄧㄥˋ ㄧㄣ"},{ja:"普段は電車の中で本を読んでいる",answer:"我平常都會在電車上看書。",zhuyin:"ㄨㄛˇ ㄆㄧㄥˊ ㄔㄤˊ ㄉㄡ ㄏㄨㄟˋ ㄗㄞˋ ㄉㄧㄢˋ ㄔㄜ ㄕㄤˋ ㄎㄢˋ ㄕㄨ"}]},
  {category:"継続",pattern:"V＋個不停",zhuyin:"V ＋ ㄍㄜ˙ ㄅㄨˋ ㄊㄧㄥˊ",meaning:"Vし続ける／いつまでもVが止まらない",note:"同じ動作がずっと続いて止まらない様子。話す・笑う・泣くなどによく使う。",example:"他一直講個不停。",exampleZhuyin:"ㄊㄚ ㄧˋ ㄓˊ ㄐㄧㄤˇ ㄍㄜ˙ ㄅㄨˋ ㄊㄧㄥˊ",tags:["継続","会話","台湾人よく使う"],prompts:[{ja:"彼はずっとしゃべり続けている",answer:"他一直講個不停。",zhuyin:"ㄊㄚ ㄧˋ ㄓˊ ㄐㄧㄤˇ ㄍㄜ˙ ㄅㄨˋ ㄊㄧㄥˊ"},{ja:"彼女は笑いが止まらなかった",answer:"她笑個不停。",zhuyin:"ㄊㄚ ㄒㄧㄠˋ ㄍㄜ˙ ㄅㄨˋ ㄊㄧㄥˊ"}]},
  {category:"強調",pattern:"就是＋否定",zhuyin:"ㄐㄧㄡˋ ㄕˋ ＋ ㄈㄡˇ ㄉㄧㄥˋ",meaning:"どうしても～ない／まさに～ないんだ",note:"『就是不～』『就是沒～』など。否定を強く言い切り、意志の強さや『なぜかそうならない』感じを出す。",example:"我就是記不起來。",exampleZhuyin:"ㄨㄛˇ ㄐㄧㄡˋ ㄕˋ ㄐㄧˋ ㄅㄨˋ ㄑㄧˇ ㄌㄞˊ",tags:["強調","否定","会話"],prompts:[{ja:"どうしても思い出せないんだよ",answer:"我就是記不起來。",zhuyin:"ㄨㄛˇ ㄐㄧㄡˋ ㄕˋ ㄐㄧˋ ㄅㄨˋ ㄑㄧˇ ㄌㄞˊ"},{ja:"私はどうしても行きたくない",answer:"我就是不想去。",zhuyin:"ㄨㄛˇ ㄐㄧㄡˋ ㄕˋ ㄅㄨˋ ㄒㄧㄤˇ ㄑㄩˋ"}]},
  {category:"珍しさ",pattern:"難得＋いつもと違うこと",zhuyin:"ㄋㄢˊ ㄉㄜˊ ＋ ㄆㄧㄥˊ ㄔㄤˊ ㄅㄨˋ ㄧˊ ㄧㄤˋ ㄉㄜ˙ ㄕˋ",meaning:"珍しく～／せっかく珍しく～",note:"普段とは違う珍しい行動や状態を言う。後ろの内容が良い機会なら『せっかく』のニュアンスにもなる。ここでは難得をㄋㄢˊ ㄉㄜˊと読む。",example:"你昨天難得那麼早回來。",exampleZhuyin:"ㄋㄧˇ ㄗㄨㄛˊ ㄊㄧㄢ ㄋㄢˊ ㄉㄜˊ ㄋㄚˋ ㄇㄜ˙ ㄗㄠˇ ㄏㄨㄟˊ ㄌㄞˊ",tags:["会話","習慣","発音注意"],prompts:[{ja:"昨日は珍しくあんなに早く帰ってきたね",answer:"你昨天難得那麼早回來。",zhuyin:"ㄋㄧˇ ㄗㄨㄛˊ ㄊㄧㄢ ㄋㄢˊ ㄉㄜˊ ㄋㄚˋ ㄇㄜ˙ ㄗㄠˇ ㄏㄨㄟˊ ㄌㄞˊ"},{ja:"せっかく台湾に来たんだから、夜市に行こう",answer:"難得來台灣，我們去逛夜市吧。",zhuyin:"ㄋㄢˊ ㄉㄜˊ ㄌㄞˊ ㄊㄞˊ ㄨㄢ，ㄨㄛˇ ㄇㄣ˙ ㄑㄩˋ ㄍㄨㄤˋ ㄧㄝˋ ㄕˋ ㄅㄚ˙"}]},
  {category:"判断",pattern:"一看就知道～",zhuyin:"ㄧˊ ㄎㄢˋ ㄐㄧㄡˋ ㄓ ㄉㄠˋ～",meaning:"見ればすぐ～だと分かる／一目で分かる",note:"見るだけで判断できるほど明らかな時。後ろに判断した内容を置く。",example:"我一看就知道你沒睡飽。",exampleZhuyin:"ㄨㄛˇ ㄧˊ ㄎㄢˋ ㄐㄧㄡˋ ㄓ ㄉㄠˋ ㄋㄧˇ ㄇㄟˊ ㄕㄨㄟˋ ㄅㄠˇ",tags:["判断","一～就～","会話"],prompts:[{ja:"見れば寝不足だってすぐ分かるよ",answer:"我一看就知道你沒睡飽。",zhuyin:"ㄨㄛˇ ㄧˊ ㄎㄢˋ ㄐㄧㄡˋ ㄓ ㄉㄠˋ ㄋㄧˇ ㄇㄟˊ ㄕㄨㄟˋ ㄅㄠˇ"},{ja:"一目で台湾で撮った写真だと分かった",answer:"我一看就知道是在台灣拍的。",zhuyin:"ㄨㄛˇ ㄧˊ ㄎㄢˋ ㄐㄧㄡˋ ㄓ ㄉㄠˋ ㄕˋ ㄗㄞˋ ㄊㄞˊ ㄨㄢ ㄆㄞ ㄉㄜ˙"}]}
];
for (const item of v68Patterns) { if (!patterns.some(p => p.pattern === item.pattern)) patterns.push(item); }
